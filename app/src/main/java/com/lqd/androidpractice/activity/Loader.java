...
public class Loader {
    ...
    static void normalMenuStartUp(CarouseActivity mainActivity, Class[] activitiesDemo) {
    ...
    private static String[] getLayouts(Test filter) {
        ...
        Field[] f = com.lqd.androidpractice.R.layout.class.getDeclaredFields();
    ...
    public static void launch(CarouseActivity mainActivity, String id) {
        Intent intent = new Intent(mainActivity, CarouseActivity.class);
